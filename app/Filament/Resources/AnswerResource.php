    ...
    return $table
        ...
        ->actions([
            ...
            DeleteAction::make('delete')->label('Obriši')
                ->modalHeading('Obriši Odgovor')
                ->modalSubheading('Jeste li sigurni da želite obrisati ovaj Odgovor?')
                ->successNotificationTitle('Odgovor je obrisan.'),
        ])
        ->bulkActions([
            DeleteBulkAction::make()
                ->modalHeading('Obriši Odgovore')
                ->modalSubheading('Jeste li sigurni da želite obrisati ove Odgovore?')
                ->successNotificationTitle('Odgovori su obrisani.'),
        ]);
    }
