...
class ExpenseResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->label('Obriši')
    ->modalHeading('Obriši Trošak')
    ->modalSubheading('Jeste li sigurni da želite obrisati ovaj Trošak?')
    ->successNotificationTitle('Trošak je obrisan.'),
        ])
    ->bulkActions([
    DeleteBulkAction::make()
        ->modalHeading('Obriši Troškove')
        ->modalSubheading('Jeste li sigurni da želite obrisati ove Troškove?')
        ->successNotificationTitle('Troškovi su obrisani.'),
            ])
            ->headerActions([
